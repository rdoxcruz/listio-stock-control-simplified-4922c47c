...
// Solution carousel — tabs + autoplay
(function () {
  function initSolutionCarousel() {
    var tabs = Array.prototype.slice.call(document.querySelectorAll('.solution__tab'));
    var panels = Array.prototype.slice.call(document.querySelectorAll('.solution__panel'));
    var section = document.getElementById('recursos') || document.querySelector('.solution');
    var INTERVAL = 4500;
    ...
    function activate(idx, restartTimer) {
      current = idx;
    ...
    tabs.forEach(function (tab, idx) {
      ...
      tab.addEventListener('focus', stopTimer);
      tab.addEventListener('blur', startTimer);
    });
  ...
  if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', initSolutionCarousel);
  } else {
