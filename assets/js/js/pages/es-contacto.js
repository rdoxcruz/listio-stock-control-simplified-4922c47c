...
/* Lucide init */
    ...
    // Menú móvil (cierra al hacer clic fuera / ESC / clic en enlace)
    (function () {
    ...
    (function(){
      ...
      function buildMessage(){
        ...
        const lines = [
          "¡Hola! Vengo del sitio de Listio.",
          "",
          `Nombre: ${name || "-"}`,
          `Tienda: ${store || "-"}`,
          `Asunto: ${subject || "-"}`,
      ...
      function validate(){
        ...
        hint.textContent = ok
          ? "Al enviar, serás redirigido a WhatsApp con el mensaje rellenado."
          : "Completa Nombre, Asunto y Mensaje para enviar.";
      ...
      copyBtn.addEventListener("click", async () => {
        ...
        try{
          ...
          hint.textContent = "Mensaje copiado. Ahora solo tienes que pegarlo en WhatsApp.";
        }catch{
          hint.textContent = "No pude copiar automáticamente. Selecciona y copia el texto manualmente.";
        }
      });
    })();
...
(function(){
      ...
      function applyConsent(consent){
        // Conecta GA4/GTM aquí según consent.analytics
      }
