...
<header class="lm-header">
  <nav class="lm-nav" role="banner" aria-label="Navegação principal">
    <a class="lm-logo" href="/">
      <img src="/img/logo-listio-dark.png" alt="Listio" class="lm-logo-img">
    </a>
    <ul class="lm-links">
...
<div class="lm-drawer" id="lmDrawer" role="navigation" aria-label="Menu mobile">
  <div class="lm-drawer__header">
    <span class="lm-drawer__logo">
      <img src="/img/logo-listio-light.png" alt="Listio" class="lm-drawer__logo-img">
    </span>
  ...
  <div class="container listio-footer__inner">
    <div class="listio-footer__top">
      <div class="listio-footer__brand">
        <div class="listio-footer__logo">
          <img src="/img/logo-listio-light.png" alt="Listio" class="listio-footer__logo-img">
        </div>
...
<nav class="floating-nav" id="floatingNav" aria-label="Menu Rápido">
  <a href="/" class="floating-nav__logo">
    <img src="/img/logo-listio-dark.png" alt="Listio" style="height: 43px; width: auto; display: block;">
  </a>
